        ...
        try (Workbook workbook = WorkbookFactory.create(excelFile)) {
            ...
            for (Row cells : sheet) {
                ...
                if (Strings.isNullOrEmpty(content)) {
                    String emptyNameMessage = sourceAccessor.getMessage("SettingService.importExcel.empty.content",
                            new Object[]{cells.getRowNum()},
                            Strings.lenientFormat(
                ...
                if (Strings.isNullOrEmpty(tab)) {
                    String emptyNameMessage = sourceAccessor.getMessage("SettingService.importExcel.empty.tab",
                            new Object[]{cells.getRowNum()},
                            Strings.lenientFormat(
