 ...
 * 软删除的审计仓库。
 * <p>
 * 设定如果继承此基础仓库，则必须使用 {@link SoftDeleteAuditableEntity} 的扩展实体，以规范软删除字段。
 * <p>
...
@NoRepositoryBean
public interface SoftDeleteAuditableRepository<E extends SoftDeleteAuditableEntity> extends BaseRepository<E> {
