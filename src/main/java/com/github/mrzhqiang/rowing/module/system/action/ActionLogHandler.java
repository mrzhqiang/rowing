...
import com.github.mrzhqiang.rowing.module.system.session.SessionDetails;
import com.github.mrzhqiang.rowing.module.system.session.SessionDetailsService;
import com.github.mrzhqiang.rowing.module.system.session.Sessions;
...
public class ActionLogHandler {
    ...
    @Pointcut("@annotation(com.github.mrzhqiang.rowing.module.system.action.Action)")
