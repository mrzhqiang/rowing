...
import com.github.mrzhqiang.rowing.api.system.session.SessionDetails;
import com.github.mrzhqiang.rowing.api.system.session.SessionDetailsService;
import com.github.mrzhqiang.rowing.api.system.session.Sessions;
...
public class ActionLogHandler {
    ...
    @Pointcut("@annotation(com.github.mrzhqiang.rowing.api.system.action.Action)")
