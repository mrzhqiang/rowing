...
import com.github.mrzhqiang.rowing.modules.session.SessionDetails;
import com.github.mrzhqiang.rowing.modules.session.SessionDetailsService;
import com.github.mrzhqiang.rowing.modules.session.Sessions;
...
public class ActionLogHandler {
    ...
    @Pointcut("@annotation(com.github.mrzhqiang.rowing.modules.action.Action)")
