...
import com.github.mrzhqiang.rowing.core.system.session.SessionDetails;
import com.github.mrzhqiang.rowing.core.system.session.SessionDetailsService;
import com.github.mrzhqiang.rowing.core.system.session.Sessions;
...
public class ActionLogHandler {
    ...
    @Pointcut("@annotation(com.github.mrzhqiang.rowing.core.system.action.Action)")
